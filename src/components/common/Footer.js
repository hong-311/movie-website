...
const FooterBlock = styled.footer`
    ...
    .notice{
        ...
        h3{
            margin-right: 20px;
            font-size: 15px; font-weight: normal; color: rgb(110, 110, 110);
        }
        a{ font-size: 15px; font-weight: bold; color: rgb(163, 163, 163); }
    }
    .family{
        ul{
            display: flex;
            ...
            li{
                margin-left: 30px;
                font-size: 15px; font-weight: normal; color: rgb(163, 163, 163);
                ...
                option{
                    font-size: 13px; font-weight: bold; color: rgb(163, 163, 163);
                    text-align: left;
                    width: 7.3rem;
                    padding: 8px 15px;
        ...
        <FooterBlock>
            <div className="f_top">
                <div className="notice">
                    <h3>공지사항</h3>
                    <a href="#!">[안내] 개인정보처리방침 개정 안내 (2023년 10월 3일)</a>
                </div>
